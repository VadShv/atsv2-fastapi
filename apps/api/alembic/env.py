"""Alembic env. URL из настроек приложения (env), модели импортируются для autogenerate."""
...
# Импорт всех моделей, чтобы Base.metadata был заполнен
...
# Подменяем URL из настроек приложения (env)
